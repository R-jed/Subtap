...
from subtap.core.clean import load_asr_segments, write_clean_segments, run_clean
from subtap.core.replacement import apply_replacements
from subtap.core.workspace import Workspace
from subtap.schemas.config import SubtapConfig, CleanConfig
from subtap.schemas.glossary import Glossary, GlossaryTerm, GlossaryReplacement, load_glossary
...
def test_apply_replacements_basic():
    ...
    segments = [
        ASRSegment(chunk_id=0, segment_id=0, start_sec=0.0, end_sec=2.0,
...
def test_apply_replacements_case_insensitive():
    ...
    segments = [
        ASRSegment(chunk_id=0, segment_id=0, start_sec=0.0, end_sec=1.0,
...
""")
    ...
    segs = [CleanSegment.model_validate_json(l) for l in lines]
