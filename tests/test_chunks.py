...
def test_split_chunks_produces_jsonl(sample_wav: Path, test_config: SubtapConfig, tmp_path: Path):
...
def test_chunks_time_monotonic(sample_wav: Path, test_config: SubtapConfig, tmp_path: Path):
...
def test_chunks_paths_exist(sample_wav: Path, test_config: SubtapConfig, tmp_path: Path):
